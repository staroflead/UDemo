...
function displayTop5(){
    ...
    // console.log(obj);
    var jsonString = sessionStorage.getItem('top5');
    var top5Array = JSON.parse(jsonString);
    if (top5Array == null) {
        top5Array = [];
        top5Array.push(obj);
    }else{
        ...
        for (i ; i < top5Array.length(); i++){
            if (obj.score > top5Array[i].score)
                break;
        }
    ...
    for (i = 0; i < top5Array.length; i++){
        $('#rank'+i).text(top5Array[i].name);
        $('#score'+i).text(top5Array[i].score);
    }
    jsonString = JSON.stringify(top5Array);
    sessionStorage.setItem('top5',jsonString);
    // console.log(top5Array);
    // console.log(JSON.stringify(top5Array));
    // console.log(JSON.parse(JSON.stringify(top5Array)));
